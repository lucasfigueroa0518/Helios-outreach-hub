...
Do not write any email signature. Never end with the sender's name, title, company, "Best," "Regards," or any sign-off block. The product appends a separate HTML signature (headshot + name + title + company) after the body; a text signature in the body creates a duplicate.
